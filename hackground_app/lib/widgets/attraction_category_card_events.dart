...
class AttractionCategoryCardEvents extends StatelessWidget {
  final Attraction attraction;

  const AttractionCategoryCardEvents(this.attraction, {Key? key})
      : super(key: key);
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '${attraction.fullAdress} • ${attraction.distance} ${attraction.distType}',
                            style: Theme.of(context)
                                .textTheme
                                .bodyText2
                                ?.copyWith(
