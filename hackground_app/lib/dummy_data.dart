...
List<Attraction> attractionList1 = [
  Attraction(
    imgSrc:
        'https://static.tildacdn.com/tild3565-3934-4638-b466-633366663735/photo_2022-05-11_18-.jpg',
    name: 'Хаят',
    starRating: 4.8,
    distance: 319,
    price: 4000,
  ...
  Attraction(
    imgSrc:
        'https://cdn.ostrovok.ru/t/1024x768/extranet/media/5eb24bc3ebbf4297b3fa717771e59743.jpg',
    name: 'Ночной Квартал',
    starRating: 4.6,
    distance: 519,
    price: 2400,
  ...
  Attraction(
    imgSrc:
        'https://cdn.ostrovok.ru/t/1024x768/content/60/9d/609db600867bc16928810226e43f5b52435fd3ac.jpeg',
    name: 'Дежа Вю',
    starRating: 4.8,
    distance: 1.6,
    price: 3500,
  ...
  Attraction(
    imgSrc:
        'https://cdn.ostrovok.ru/t/1024x768/content/82/1c/821c4ce9572772217545f666987c273bf429fe8b.jpeg',
    name: 'Интурист',
    starRating: 4.2,
    distance: 319,
    price: 2300,
...
List<Attraction> attractionList3 = [
  Attraction(
    imgSrc:
        'https://vsrap.ru/wp-content/uploads/2020/08/maxkorzh-e1596907664553.jpg',
  ...
  Attraction(
    imgSrc:
        'https://akademichesky.mos.ru/upload/medialibrary/f82/yarmarka-vykhodnogo-dnya.jpg',
    name: 'Ярмарка',
    date: '24 мая, 11:00',
  ...
  Attraction(
    imgSrc:
        'https://cdn.pbilet.com/origin/574c7bcc-2b13-43ea-81a3-186e12b29881.jpeg',
    name: 'Концерт Би-2',
    date: '17 мая, 23:00',
    address: "Горько 34",
    price: 2500,
  ...
  Attraction(
    imgSrc:
        'https://i.pinimg.com/originals/53/0d/9a/530d9a5703ada7cc8eacbb4d8b5beb5f.jpg',
