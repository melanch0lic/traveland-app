...
class ExcursionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isConnected = context.select((PlacesPageViewModel model) => model.isConnectedExcursions);
    ...
    return isLoading
        ...
        : isConnected
            ...
            : SocketErrorWidget(callback: () => context.read<PlacesPageViewModel>().refreshExcursions());
  }
}
