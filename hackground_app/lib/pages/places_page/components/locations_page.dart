...
class LocationsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isConnected = context.select((PlacesPageViewModel model) => model.isConnectedLocations);
    ...
    return isLoading
        ...
        : isConnected
            ...
            : SocketErrorWidget(callback: () => context.read<PlacesPageViewModel>().refreshLocations());
  }
}
