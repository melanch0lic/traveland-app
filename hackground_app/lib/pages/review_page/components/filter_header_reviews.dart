...
class FilterHeaderReviews extends StatelessWidget {
  const FilterHeaderReviews({Key? key}) : super(key: key);
      ...
      children: [
        Expanded(
          child: AnimatedCrossFade(
            ...
            crossFadeState:
                sortFlag ? CrossFadeState.showSecond : CrossFadeState.showFirst,
