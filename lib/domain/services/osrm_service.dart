...
import '../../data/network/models/response/search_response.dart';
...
class OsrmService {
  ...
  Future<Result<SearchResponse>> getAllPlacesBySearch(String searchText) async {
    final response = await mainApiClient.getAllPlacesBySearch(searchText);
    return response;
  }
